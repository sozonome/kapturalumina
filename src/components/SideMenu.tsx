...
import { IonMenu, IonContent, IonList, IonListHeader, IonMenuToggle, IonItem, IonLabel, IonIcon, IonText, IonTextarea } from '@ionic/react'
import './SideMenu.css';
import { homeSharp, listSharp, personSharp, logInSharp, logOutSharp, codeSharp, informationCircleSharp, openSharp } from 'ionicons/icons';
    ...
    <IonMenu type="overlay" contentId="main">
      <IonContent>
        ...
        <IonList lines="none">
          ...
          <IonItem>
            <p style={{letterSpacing:'0.1em', fontWeight:450, fontSize:'0.8em'}}>Jika Anda telah mencoba menggunakan aplikasi ini, silakan mengisi form di bawah ini. Terima Kasih</p>
          </IonItem>
          <IonItem 
